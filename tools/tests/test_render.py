...
def test_the_artifact_reports_the_same_counts_as_the_graph() -> None:
    ...
    # 83 falsification conditions is the headline number and the reason the graph exists:
    # 78 in document frontmatter plus 5 in decision cells.
    assert "<dd>83</dd>" in page
