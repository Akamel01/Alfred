...
def test_the_artifact_reports_the_same_counts_as_the_graph() -> None:
    ...
    # 82 falsification conditions is the headline number and the reason the graph exists:
    # 77 in document frontmatter plus 5 in decision cells.
    assert "<dd>82</dd>" in page
