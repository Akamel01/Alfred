...
kind: tier
id: "tier:tier3"
title: "Tier 3 — Agent specifications"
shape: "directory"
tier: "3"
source: "docs/tier3:1"
extractor: "documents"
...
- **contains** → [[document__tier3__agent-catalog|Agent Catalog]]
- **contains** → [[document__tier3__agent-definition-standard|Agent Definition Standard]]
- **contains** → [[document__tier3__agent-evaluation-protocol|Agent Evaluation Protocol]]
...
- **contains** → [[document__tier3__tool-specification-standard|Tool Specification Standard]]
