---
kind: module
id: "module:tools.vaultgraph.extract.layout"
title: "The top-level layout as declared in the coding-standards structure fence."
shape: "module"
present: "true"
protected: "false"
lint_gated: "false"
source: "tools/vaultgraph/extract/layout.py:1"
extractor: "code"
aliases:
  - "The top-level layout as declared in the coding-standards structure fence."
  - "tools.vaultgraph.extract.layout"
generated: true
---
...
|---|---|
| `is_test` | false |
| `path` | tools/vaultgraph/extract/layout.py |
| `tree` | tools |
