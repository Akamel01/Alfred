---
kind: module
id: "module:tools.vaultgraph.extract.charter"
title: "K1-K6 and R1-R12, which live in Tier 0 and not, as the handoff assumed, in the plan."
shape: "module"
present: "true"
protected: "false"
lint_gated: "false"
source: "tools/vaultgraph/extract/charter.py:1"
extractor: "code"
aliases:
  - "K1-K6 and R1-R12, which live in Tier 0 and not, as the handoff assumed, in the plan."
  - "tools.vaultgraph.extract.charter"
generated: true
---
...
|---|---|
| `is_test` | false |
| `path` | tools/vaultgraph/extract/charter.py |
| `tree` | tools |
