---
kind: module
id: "module:tools.vaultgraph.extract.imports"
title: "What depends on what: module -> module edges, read from import statements."
shape: "module"
present: "true"
protected: "false"
lint_gated: "false"
source: "tools/vaultgraph/extract/imports.py:1"
extractor: "code"
aliases:
  - "What depends on what: module -> module edges, read from import statements."
  - "tools.vaultgraph.extract.imports"
generated: true
---
...
|---|---|
| `is_test` | false |
| `path` | tools/vaultgraph/extract/imports.py |
| `tree` | tools |
