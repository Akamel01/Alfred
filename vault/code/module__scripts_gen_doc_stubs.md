...
- [[adr__ADR-0064|The cross-stage invariants are reclassified provisional and stop re-listing what the lint ]] **enforced_by** → this — "ENFORCEMENT map as the authority on which holds which; provisional per ADR-0064 because that "
