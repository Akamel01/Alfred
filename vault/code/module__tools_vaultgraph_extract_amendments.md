---
kind: module
id: "module:tools.vaultgraph.extract.amendments"
title: "A1-A12, and the edges from an amendment to the decision it amends."
shape: "module"
present: "true"
protected: "false"
lint_gated: "false"
source: "tools/vaultgraph/extract/amendments.py:1"
extractor: "code"
aliases:
  - "A1-A12, and the edges from an amendment to the decision it amends."
  - "tools.vaultgraph.extract.amendments"
generated: true
---
...
|---|---|
| `is_test` | false |
| `path` | tools/vaultgraph/extract/amendments.py |
| `tree` | tools |
