...
- [[gate-step__integrity_26|State authority lint checks its own vacuity]] **runs** → this
- [[gate-step__integrity_27|Ownership router homes exist and no gate cites runtime state]] **runs** → this
